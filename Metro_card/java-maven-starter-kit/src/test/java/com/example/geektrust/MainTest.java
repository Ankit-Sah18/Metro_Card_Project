...
public class MainTest {
	...
	public void input1() {
		...
		String filePath= "src/test/java/inputTest/Input1";
		String actualOutput= metroCardService.processMetroCardExcution(filePath);
		
		String exceptedOutput= "TOTAL_COLLECTION CENTRAL 300 0\n"
		...
		assertEquals(exceptedOutput.trim(), actualOutput);
	...
	public void input2() {
		...
		String filePath= "src/test/java/inputTest/Input2";
		String actualOutput= metroCardService.processMetroCardExcution(filePath);
	...
	@Test
	public void input3() {
		String filePath= "src/test/java/inputTest/Input3";
		String actualOutput= metroCardService.processMetroCardExcution(filePath);
	...
	@Test
	public void input4() {
		String filePath= "src/test/java/inputTest/Input4";
		String actualOutput= metroCardService.processMetroCardExcution(filePath);
